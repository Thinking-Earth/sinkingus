...
const String basePath = "assets/svgs";

@immutable
class AppSvgs {
  const AppSvgs._();

  static String camera_1 = "$basePath/camera_1.svg";
  static String flogging = "$basePath/flogging.svg";
  static String camera = "$basePath/camera.svg";
  static String trab = "$basePath/trab.svg";
  ...
  static String snackIcon = "$basePath/snack_icon.svg";
  static String penIcon = "$basePath/editable_pencil_icon.svg";
  ...
  static String paper = "$basePath/paper.svg";
  ...
  static String paperStroke = "$basePath/paper_stroke.svg";

  static String familyPictureBtn = "$basePath/family_picture_btn.svg";
  ...
  static String xmark = "$basePath/xmark.svg";
}
